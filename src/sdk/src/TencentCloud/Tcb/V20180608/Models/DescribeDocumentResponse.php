 ...
 * @method string getDocumentList() 获取查询结果，json
 * @method void setDocumentList(string $DocumentList) 设置查询结果，json
...
class DescribeDocumentResponse extends AbstractModel
{
     ...
     * @param string $DocumentList 查询结果，json
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("DocumentList",$param) and $param["DocumentList"] !== null) {
            $this->DocumentList = $param["DocumentList"];
        }
